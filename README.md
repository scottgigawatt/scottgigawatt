...
Hi, I'm **Scott Gigawatt** — a dev powered by caffeine, shell scripts, and occasional bursts of cosmic radiation. I write code on macOS, run my homelab like a rogue science experiment on Synology, and containerize everything short of my morning coffee. Somewhere between a malformed cron job and a glowing Raspberry Pi cluster, I found enlightenment — or maybe just a log loop. Either way, welcome to the lab.
...
- 🌌 Forever obsessed with **space, science, tech**, and making things look clean (✨beautiful code✨)
...
- [ ] Building a universal media tag-cleaner that doesn't cry on special characters
- [ ] Creating a network diagram so cool it bends space-time
- [ ] Actually documenting any of this

## 🛰️ Find Me in the Timeline

- Occasionally in 1985 🕰️
- Probably mid-container-restart
- Definitely staring at Grafana dashboards like they're stock tickers

## ⚠️ Warning

> [!WARNING]
> Repo may contain traces of sarcasm, outdated dependencies, and unstable neutrino flows. Proceed with curiosity.
